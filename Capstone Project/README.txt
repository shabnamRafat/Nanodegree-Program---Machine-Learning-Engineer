...
scratch. With just 5 epochs, the model got 75% accuracy.</p>
...
accuracy of 81% on test data. The model correctly predicted breeds for 632 images out of 836 total images.</p>

**Accuracy on test data: 75% (632/836)**
